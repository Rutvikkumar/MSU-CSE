...
const courses = [
    {
        id: 'BE', title: 'Bachelor of Engineering', description: (
    ...
    {
        id: 'BCA', title: 'Bachelor of Computer Applications', description: (<table>
            <tbody>
                <tr>
                    <td className="border px-4 py-2 font-semibold w-1/4">Program:</td>
                    <td className="border px-4 py-2">Master of Computer Application (MCA)</td>
                </tr>
                <tr>
                    ...
                    <td className="border px-4 py-2">
                        ...
                        ii: Verification of Certificates and payment of the stipulated fees of The Maharaja Sayajirao University of Baroda For Diploma to Degree/
                        iii:Certificate to Diploma (Second year Lateral Admission) admitted students, please register on MSUIS Website
                        5	:	For Diploma to Degree/ Certificate to Diploma (Second year Lateral Admission) admitted students, please register on MSUIS Website

                    </td>
                </tr>
                <tr>
                    <td className="border px-4 py-2 font-semibold">Program level:</td>
                    <td className="border px-4 py-2">Post Graduate</td>
                </tr>
                <tr>
                    <td className="border px-4 py-2 font-semibold">Program mode:</td>
                    <td className="border px-4 py-2">Regular</td>
                </tr>
                <tr>
                    <td className="border px-4 py-2 font-semibold">Subjects offered:</td>
                ...
                <tr>
                    ...
                    <td className="border px-4 py-2">
                        ...
                        Min Percentage:	:	45
                        OR
                        Eligibility Group :	:	Bachelor's Degree-Unreserved category
                        Required Qualification:	:	Under Graduate Degree(UG)
                        Specialisation(If Any):	:	Any
                        Min Percentage:	:	50
                ...
                <tr>
                    <td className="border px-4 py-2 font-semibold">Intake capacity:</td>
                    <td className="border px-4 py-2">45</td>
                </tr>
                <tr>
                    <td className="border px-4 py-2 font-semibold">Duration of Program:</td>
                    <td className="border px-4 py-2">2 Years (04 semesters)</td>
                </tr>
                <tr>
                    <td className="border px-4 py-2 font-semibold">Mode of Admission:</td>
                    <td className="border px-4 py-2">Admission Through ACPC Portal</td>
                </tr>
                <tr>
                    <td className="border px-4 py-2 font-semibold">Opening Dates for online application:</td>
                    <td className="border px-4 py-2">09/09/2021</td>
                </tr>
                <tr>
                    <td className="border px-4 py-2 font-semibold">Closing Dates for online application:</td>
                    <td className="border px-4 py-2">25/10/2021</td>
                </tr>
                <tr>
                    <td className="border px-4 py-2 font-semibold">Contact Person Info:</td>
                    <td className="border px-4 py-2">Head of the Computer Science and Engineering Department, Faculty of Technology and Engineering 0265-2434188 Ext. 202 / 0265 2417943</td>
                </tr>
                <tr>
                    <td className="border px-4 py-2 font-semibold">Application Link</td>
                    <td className="border px-4 py-2"><a href="#" className="text-blue-500 underline">Click here to Apply</a></td>
                </tr>
                <tr>
                    <td className="border px-4 py-2 font-semibold">Prospectus:</td>
                    <td className="border px-4 py-2"><a href="#" className="text-blue-500 underline">Download</a></td>
                </tr>
            </tbody>
        </table>
        )
    ...
    {
        id: 'PhD', title: 'Doctor of Philosophy', description: (<table className="table-auto w-full border-collapse border border-gray-300 mt-2">
            <tbody>
                <tr>
                    <td className="border px-4 py-2 font-semibold w-1/4">Program:</td>
                    <td className="border px-4 py-2">Ph.D in Computer Science and Engineering</td>
                </tr>
                <tr>
                    <td className="border px-4 py-2 font-semibold">Details:</td>
                    <td className="border px-4 py-2"></td>
                ...
                <tr>
                    <td className="border px-4 py-2 font-semibold">Program level:</td>
                    <td className="border px-4 py-2">Doctorate</td>
                </tr>
                <tr>
                    <td className="border px-4 py-2 font-semibold">Program mode:</td>
                    <td className="border px-4 py-2">Regular Program</td>
                </tr>
                <tr>
                    <td className="border px-4 py-2 font-semibold">Subjects offered:</td>
                    <td className="border px-4 py-2"></td>
                ...
                <tr>
                    <td className="border px-4 py-2 font-semibold">Eligibility criteria:</td>
                    <td className="border px-4 py-2">ME/M.Tech (CSE/IT) / MCA</td>
                </tr>
                <tr>
                    <td className="border px-4 py-2 font-semibold">Intake capacity:</td>
                ...
                <tr>
                    <td className="border px-4 py-2 font-semibold">Duration of Program:</td>
                    <td className="border px-4 py-2">Min 3 Years</td>
                </tr>
                <tr>
                    <td className="border px-4 py-2 font-semibold">Mode of Admission:</td>
                    <td className="border px-4 py-2">Entrance Test [PET]/GATE/SET/NET + Personal Interview</td>
                </tr>
                <tr>
                    <td className="border px-4 py-2 font-semibold">Opening Dates for online application:</td>
                    <td className="border px-4 py-2"></td>
